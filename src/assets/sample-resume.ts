      ...
      entries: [
        ...
        },
        {
          ...
          bulletPoints: [
            {
              id: "exp-2-bp-1",
              text: "Architected CodeHealth, an \\textbf{LLM}-powered platform on \\textbf{AWS} with \\textbf{Azure OpenAI} and \\textbf{RAG}, enabling natural language querying of repo health and vulnerabilities, reducing manual code review time by 40\\%.",
              enabled: true,
              displayOrder: 0,
            },
            {
            ...
            {
              id: "exp-2-bp-3",
              text: "Built a \\textbf{Kafka}-based real-time scan pipeline for parallel execution of security, quality, dependency, and secret scans, processing 5M+ scan events/day with exactly-once delivery semantics.",
              enabled: true,
              displayOrder: 2,
            },
            {
            ...
            {
              id: "exp-2-bp-5",
              text: "Engineered \\textbf{CI/CD} plugins for \\textbf{GitHub Actions} and \\textbf{GitLab CI} with quality gates and inline PR annotations, reducing vulnerability-introducing deployments by 60\\%.",
              enabled: true,
              displayOrder: 4,
            },
            {
              id: "exp-2-bp-6",
              text: "Implemented \\textbf{circuit breakers} and fallback handlers across NVD, OSV, and GitHub Advisory integrations, maintaining 99.9\\% scan service availability during failures.",
              enabled: true,
              displayOrder: 5,
            },
            {
              id: "exp-2-bp-7",
              text: "Built an \\textbf{MDC}-based async logging utility with thread boundary context propagation for \\textbf{multi-threaded} scan tracking, increasing audit log coverage by 75\\%.",
              enabled: true,
              displayOrder: 6,
            },
            {
              id: "exp-2-bp-8",
              text: "Constructed \\textbf{Grafana} dashboards to monitor pipeline health, queue depths, and API latency across 10+ microservices, cutting incident response time by 35\\%.",
              enabled: true,
              displayOrder: 7,
            },
            {
              id: "exp-2-bp-9",
              text: "Devised modular \\textbf{Bash} scripts for air-gapped enterprise repo ingestion, enabling on-premise scanning without exposing source code externally.",
              enabled: true,
              displayOrder: 8,
            },
            {
              id: "exp-2-bp-10",
              text: "Automated nightly scans and \\textbf{SBOM} generation for 1000+ repositories using a \\textbf{job scheduler}, delivering daily health digest reports to engineering leads.",
              enabled: true,
              displayOrder: 9,
            },
            {
              id: "exp-2-bp-11",
              text: "Spearheaded a \\textbf{React} dashboard with org-level health scores, trend charts, and finding drill-downs across security and reliability metrics, achieving 90\\% \\textbf{Jest} test coverage.",
              enabled: true,
              displayOrder: 10,
            },
          ],
